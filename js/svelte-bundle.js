...
var app = (function () {
    ...
    const user = writable(JSON.parse(localStorage.getItem('user')) || initialValue);
    ...
    function create_fragment(ctx) {
    	let p;
    	let t0_value = JSON.stringify(/*$user*/ ctx[0]) + "";
    	let t0;
    	let t1;
    	let input;
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			buton = element("buton");
    			buton.textContent = "New Challenge";
    			t4 = space();
    			main = element("main");
    			create_component(startchallenge.$$.fragment);
    			t5 = space();
    			create_component(createchallenge.$$.fragment);
    			add_location(p, file, 45, 0, 1136);
    			add_location(input, file, 46, 0, 1167);
    			add_location(buton, file, 47, 0, 1202);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(buton, "click", prevent_default(/*handleNewChallenge*/ ctx[1]), false, true, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*$user*/ 1) && t0_value !== (t0_value = JSON.stringify(/*$user*/ ctx[0]) + "")) set_data_dev(t0, t0_value);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	//   };
    	// });
    	const days = Array(30).fill(null).map((e, i) => {
    		return {
    			id: v4(),
    			isComplete: false,
    			nday: i + 1,
    	...
    	const handleNewChallenge = () => {
    		...
    		set_store_value(user, $user.currentChallenge = newChallenge, $user);
    	};
    	...
    	return [$user, handleNewChallenge, input_input_handler];
    }
